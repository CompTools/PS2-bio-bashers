...
# The above line assigns the variable "FILE" to the original CSV file
...
# airport information input and then to a grep command to count the number of flights that were delayed.
